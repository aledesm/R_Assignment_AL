...
##You should call the library at some point before this
##I get an error when I try to run this saying that it is deprecated
```
...
## I got a warning message with this
```
...
## Is there supposed to be no bar for NA?
```
...
## I don't know if you have the right count for NA, it looks different from what I've seen so far
```
...
##The lack  of any bar for NA makes me think that something is going wrong with your code but I can't find it
```
...
## This is the same as the previous graph but a scatterplot instead of a bar 
```
